...
describe('Decode', () => {
    ...
    test('getDestinationReservedBitOne() === false', () => {
        expect(incoming.getDestinationReservedBitOne()).toBeFalse()
    })

    test('getDestinationReservedBitTwo() === false', () => {
        expect(incoming.getDestinationReservedBitTwo()).toBeFalse()
    })
    ...
    test('isSourceAcceptingCompression()', () => {
        expect(incoming.isSourceAcceptingCompression()).toBeFalse()
    })
    ...
    test('getFrameType() === unnumbered', () => {
        expect(incoming.getFrameType()).toBe('UI')
    })
    ...
    test('hasPid() === true', () => {
        expect(incoming.hasPid()).toBeTrue()
    })
    ...
    test('hasRepeaters() === true', () => {
        expect(incoming.hasRepeaters()).toBeTrue()
    })
